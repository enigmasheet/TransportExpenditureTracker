...
namespace TransportExpenditureTracker.Migrations
{
    ...
    [Migration("20250811083805_changedquantitytodecimal")]
    partial class changedquantitytodecimal
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TransportExpenditureTracker.Models.Invoice", b =>
                {
                    ...
                    b.HasIndex("InvoiceNo", "PartyId", "CompanyId")
                        .IsUnique()
            ...
            modelBuilder.Entity("TransportExpenditureTracker.Models.Invoice", b =>
                {
                    b.HasOne("TransportExpenditureTracker.Models.Company", "Company")
                        .WithMany()
            ...
            modelBuilder.Entity("TransportExpenditureTracker.Models.UserCompany", b =>
                {
                    ...
                    b.HasOne("TransportExpenditureTracker.Models.ApplicationUser", "User")
                        .WithOne("UserCompany")
                        .HasForeignKey("TransportExpenditureTracker.Models.UserCompany", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
